...
if (!function_exists('wpbscook_setup')) {
    /**
...
if (!function_exists('wpbscook_widgets_init')) {
    /**
    ...
    function wpbscook_widgets_init()
    {
        ...
        register_sidebar(array(
            ...
            'id' => 'footer-sidebar-1',
            'description' => __('Add widgets here to appear in your left footer sidebar.',
                'wpbscook'),
        ...
        register_sidebar(array(
            ...
            'id' => 'footer-sidebar-2',
            'description' => __('Add widgets here to appear in your middle footer sidebar.',
                'wpbscook'),
        ...
        register_sidebar(array(
            ...
            'id' => 'footer-sidebar-3',
            'description' => __('Add widgets here to appear in your right footer sidebar.',
                'wpbscook'),
...
} // wpbscook_widgets_init
add_action('widgets_init', 'wpbscook_widgets_init');

if (!function_exists('wpbscook_scripts')) {
    /**
    ...
    function wpbscook_scripts()
    {
        ...
        if (!is_admin()) {
            ...
            wp_enqueue_style('wpbscook_greatvibes',
                ...
                array(), null);
            // Main stylesheet
            wp_enqueue_style('wpbscook_style', get_stylesheet_uri(),
        ...
        if (!is_admin()) {
            ...
            wp_enqueue_script('wpbscook_bootstrap_script',
                get_template_directory_uri() . '/assets/js/bootstrap.min.js', array('jquery'),
                '3.3.2', true);
            #wp_enqueue_script('wpbscook_script',
            #    get_template_directory_uri() . '/assets/js/functions.js',
            #    array('wpbscook_bootstrap_script'), null, true);
            // Comments script
...
if (!function_exists('wpbscook_attachment_redirect')) {
    /**
...
} // wpbscook_attachment_redirect
add_action('template_redirect', 'wpbscook_attachment_redirect', 1);

if (!function_exists('wpbscook_comments')) {
...
if (!function_exists('wpbscook_word_count')) {
    /**
...
if (!function_exists('wpbscook_modify_comment_form')) {
    /**
...
} // wpbscook_modify_comment_form
add_filter('comment_form_default_fields', 'wpbscook_modify_comment_form');

if (!function_exists('wpbscook_modify_comment_textarea')) {
    /**
...
} // wpbscook_modify_comment_textarea
add_filter('comment_form_defaults', 'wpbscook_modify_comment_textarea');

if (!function_exists('wpbscook_modify_comment_submit')) {
    /**
...
} // wpbscook_modify_comment_submit
add_action('comment_form', 'wpbscook_modify_comment_submit');

if (!function_exists('wpbscook_highlight_search_results')) {
    /**
    ...
    function wpbscook_highlight_search_results($text)
    {
        if (is_search()) {
            ...
            $text = preg_replace('/(' . implode('|', $keys) . ')/iu',
                '<strong class="search-excerpt">' . ucfirst($query) . '</strong>', $text);
        }

        return $text;
    }
} // wpbscook_highlight_search_results
add_filter('the_excerpt', 'wpbscook_highlight_search_results');

if (!function_exists('wpbscook_add_image_class')) {
    /**
